...
public class login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        File authfile = new File("D:/Canada/WDM_PreLibraryBookIssue_Final/web/auth.xml");
        ...
        if(!uname.equals("") && !pass.equals(""))
        {
            ...
            if(flag==1)
            {
                if(password.equals(pass))
                {
                    ...
                    doc = dbuild.parse(new File("C:/Users/D/Desktop/WDM IEP/WDM_PreLibraryBookIssue_Final/WDM_PreLibraryBookIssue_Final/web/issuedbook.xml"));
                    ...
                    for(int i=0;i<all.getLength();i++)
                    {
                        ...
                        if(username.equals(uname))
                        {
                            ...
                            {   //out.write("Inside"+"\n");
                                ...
                                StreamResult result = new StreamResult("C:/Users/D/Desktop/WDM IEP/WDM_PreLibraryBookIssue_Final/WDM_PreLibraryBookIssue_Final/web/issuedbook.xml");
