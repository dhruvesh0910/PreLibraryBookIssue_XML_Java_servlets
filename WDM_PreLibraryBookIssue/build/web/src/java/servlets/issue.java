...
public class issue extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        File bookdetailfile = new File("D:/Canada/WDM_PreLibraryBookIssue_Final/web/bookdetails.xml");
        ...
        if(!dept.equals("Select Department") && !bname.equals("Select Book") &&!bpub.equals("Select Publisher") &&!r_date.equals("yyyy-mm-dd"))
        {
            try
            {
                ...
                if(avail_check==0)
                {
                    Document doc_already = dbuild.parse("D:/Canada/WDM_PreLibraryBookIssue_Final/web/issuedbook.xml");
...
//                        Element nuid = doc_insert.createElement("uid");
//                        nuid.appendChild(doc_insert.createTextNode(uid));
//                        booknode.appendChild(nuid);
                        ...
                        StreamResult result = new StreamResult("D:/Canada/WDM_PreLibraryBookIssue_Final/web/issuedbook.xml");
                        ...
                        result = new StreamResult("D:/Canada/WDM_PreLibraryBookIssue_Final/web/bookdetails.xml");
                ...
                else if(i==all.getLength())
                {
                    ...
                    if(bname_error==0 && bpub_error==0 && avail_check!=0)
                    {
                        RequestDispatcher rd = request.getRequestDispatcher("issue_book.jsp");
                        rd.include(request, response);
                        out.write("<div class='response'>Book Not Available</div>");
                    }
                }
            }
            catch(Exception e)
